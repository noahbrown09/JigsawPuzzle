I wasn't able to get around to packing this into a .JAR file before my time in the class ended, so this must be ran via any IDE. I used JGrasp because it was required for the course, and there are detailed instructions for installing it and the requisite Java Development Kit here: 
